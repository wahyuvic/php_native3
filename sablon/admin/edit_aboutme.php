...
include "../koneksi.php";
$id=$_GET['id'];
$query_aboutme  ="SELECT * FROM aboutme where id_aboutme='$id' ";
			  ...
			  <div class="row">
			    ...
			    <div class="row style3"><div><div class="panel panel-default"><div id="dataTables-example_wrapper"><div class="table-responsive">
				  ...
				  <form action="olahdata/about_me.php" name="form1" method="post" enctype="multipart/form-data">
					...
					<p>Kejadian/kegiatan Buat Yag Bisa Buat Company Profil Perusahaan </p>
				    <table width="616" border="0">
                      <tr>
                        <td width="145">Judul Judul </td>
                        <td width="19">:</td>
                        <td width="445"><label>
                      ...
                      <tr>
                        ...
                        <td><label>
                          <table width="449" border="0">
                            <tr>
                              <td width="190"><input name="Tanggal" type="date" class="form-control" id="Jenis" value="<?php echo"$hasil_lopping[1]";?>"/></td>
                              <td></td>
