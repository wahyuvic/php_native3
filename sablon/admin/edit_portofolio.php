...
include "../koneksi.php";
$id=$_GET['id'];
$query_portofolio  ="SELECT * FROM portofolio where id_portofolio='$id' ";
		 ...
		 <div class="row">
			  ...
			  <div class="row">
			    ...
			    <div class="row style3"><div><div class="panel panel-default"><div id="dataTables-example_wrapper"><div class="table-responsive">
				  ...
				  <form action="olahdata/portofolio.php" name="form1" method="post" enctype="multipart/form-data">
				    ...
				    <table width="616" border="0">
                      ...
                      <tr>
                        ...
                        <td><label>
                          <table width="449" border="0">
                            <tr>
                              <td width="190"><input name="Jenis" type="text" class="form-control" id="Jenis" value="<?php echo"$hasil_lopping[3]";?>"/></td>
                             <td></td>
                      ...
                      <tr>
                        <td colspan="3">Keterangan
                          <label>
                          <textarea name="keterangan" rows="15" cols="100" id="keterangan"><?php echo"$hasil_lopping[4]";?></textarea>
