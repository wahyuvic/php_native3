                      ...
                      <tr>
                        ...
                        <td><label>
                          <table width="449" border="0">
                            <tr>
                              <td width="190"><input name="harga" type="text" class="form-control" id="Jenis"/></td>
                             <td></td>
                        ...
                        <td><table width="453" border="0">
                            <tr>
                              <td width="183"><span class="form-group">
								...
								<?php
							  include"../koneksi.php";
							  $lihat=mysqli_query($conn,"SELECT * FROM jenis_kaos,ukuran,warna_kaos WHERE jenis_kaos.id_ukuran=ukuran.id_ukuran AND jenis_kaos.id_warna=warna_kaos.id_warna ORDER BY jenis_kaos.id_jenis ASC");
