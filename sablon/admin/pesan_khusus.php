...
?>
        ...
        <div id="page-wrapper">
		 ...
		 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">Damar Apparel - Kontak </h1>
                    </div>
              </div>
                <!-- /. ROW  -->
			  <div class="row">
			    ...
			    <p> <a href="form_portofolio.php" class="btn btn-danger"><i class="fa fa-link"></i>Data Baru </a>
			     <?php 
                    ...
                    <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" width="100%">
                                        <thead>
                                            <tr>
                                                <th width="64">No</th>
                                                <th width="153">Nama  </th>
                                                <th width="176">Email</th>
                                                <th width="218">No Telepon </th>
                                                <th width="362">Pesan</th>
												 <th width="197">Olah Data </th>
                                            </tr>
                                        </thead>
                                        <tbody>
										<?php
										...
										$query_aboutme  ="SELECT * FROM portofolio order by id_portofolio ASC  LIMIT $offset, $dataPerPage ";
										...
										?>
                                            <tr>
                                                ...
                                                <td><img src="../img/portfolio/<?php echo"$hasil_lopping[1]";?>" width="78" height="76"/></td>
                                                <td><?php echo"$hasil_lopping[4]";?></td> 
												<td><a href="edit_portofolio.php?id=<?php echo"$hasil_lopping[0]";?>" class="btn btn-danger"><i class="fa fa-edit">Edit </i></a>-<a href="olahdata/portofolio.php?id=<?php echo"$hasil_lopping[0]";?>&Olahdata=delete" class="btn btn-danger"><i class="fa fa-pencil">Hapus</i></a></td>
                                            </tr>
                                        <?php
										}
										?>
								    ...
								    <?php
echo "</table>";
$query   = "SELECT COUNT(*) AS jumData FROM portofolio";
