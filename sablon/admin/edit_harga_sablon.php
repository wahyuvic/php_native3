...
include "../koneksi.php";
$id=$_GET['id'];
$query_portofolio  ="SELECT * FROM sablon where id_sablon='$id' ";
				    ...
				    <table width="616" border="0">
				        ...
				        <td><label>
                            <table width="452" border="0">
							  ...
							  $lihat_sablon=mysqli_query($conn,"SELECT * FROM harga_kaos,jenis_kaos,ukuran,warna_kaos
										WHERE harga_kaos.id_jenis=jenis_kaos.id_jenis AND jenis_kaos.id_ukuran=ukuran.id_ukuran AND jenis_kaos.id_warna=warna_kaos.id_warna AND harga_kaos.id_jenis='$hasil_lopping[1]' ORDER BY harga_kaos.id_harga ASC");
				      ...
				      <tr>
				        ...
				        <td><label>
                            <table width="449" border="0">
                              <tr>
                                <td width="190"><input name="nama" type="text" class="form-control" id="2" value="<?php echo"$hasil_lopping[2]"; ?>"/></td>
                                <td></td>
				      ...
				      <tr>
				        ...
				        <td><table width="453" border="0">
                            <tr>
                              <td width="192"><input name="harga" type="text" class="form-control" id="3" value="<?php echo"$hasil_lopping[3]"; ?>"/></td>
				      ...
				      <tr>
				        ...
				        <td><span class="form-group">
						  ...
						  <option value="<?php echo"$hasil_lopping[4]"; ?>"><?php echo"$hasil_lopping[4]"; ?></option>
                          <option value="Manual">Manual</option>
                            <option value="Manual+Kaos">Manual+Kaos</option>
                          </select>
                          </span>
				            <div id="pemberitahuan5"></div></td>
			          </tr>
                      <tr>
                        <td width="145">&nbsp;</td>
                        <td width="19">&nbsp;</td>
