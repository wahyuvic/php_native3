        ...
        <div id="page-wrapper">
		 ...
		 <div class="row">
			  ...
			  <div class="row">
			    ...
			    <p> <a href="form_warna.php" class="btn btn-danger"><i class="fa fa-link"></i>Data Baru </a>
			     <?php 
			      ...
			      <div id="dataTables-example_wrapper">
                    <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" width="100%">
										...
										$query_aboutme  ="SELECT * FROM warna_kaos order by id_warna ASC  LIMIT $offset, $dataPerPage ";
										...
										?>
                                            <tr>
                                                ...
                                                <td><a href="edit_warna.php?id=<?php echo"$hasil_lopping[0]";?>" class="btn btn-danger"><i class="fa fa-edit">Edit </i></a>-<a href="olahdata/warna.php?id=<?php echo"$hasil_lopping[0]";?>&Olahdata=delete" class="btn btn-danger"><i class="fa fa-pencil">Hapus</i></a></td>
                                            </tr>
                                        <?php
										}
										?>
								    ...
								    <?php
echo "</table>";
$query   = "SELECT COUNT(*) AS jumData FROM warna_kaos";
