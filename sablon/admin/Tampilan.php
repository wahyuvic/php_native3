                    ...
                    <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" width="100%">
                                        <thead>
                                            <tr>
                                                <th width="120">No</th>
                                                <th width="378">Nama Bagian Tampilan </th>
                                                <th width="267">Gambar</th>
                                                <th width="413">Olah Data </th>
                                            </tr>
                                        </thead>
                                        <tbody>
										<?php
										...
										$query_view  ="SELECT * FROM view order by id_view ASC  LIMIT $offset, $dataPerPage ";
										$result_view = mysqli_query($conn,$query_view);
										while ($hasil_lopping = mysqli_fetch_array($result_view)) {
										?>
                                            <tr>
                                                <td><?php echo"$hasil_lopping[0]";?></td>
                                                <td><?php echo"$hasil_lopping[1]";?></td>
                                                <td><img src="../img/<?php echo"$hasil_lopping[2]";?>" width="171" height="113"/></td>
                                                <td><a href="edit_view.php?id=<?php echo"$hasil_lopping[0]";?>" class="btn btn-danger"><i class="fa fa-edit">Edit </i></a></td>
                                            </tr>
                                        <?php
										}
										?>
								    ...
								    <?php
echo "</table>";
$query   = "SELECT COUNT(*) AS jumData FROM view";
