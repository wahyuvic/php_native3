		 ...
		 <div class="row">
			  ...
			  <div class="row">
			    ...
			    <div class="row style3"><div><div class="panel panel-default"><div id="dataTables-example_wrapper"><div class="table-responsive">
			      <div align="center">
				  <form action="olahdata/team.php" method="post" name="form1" enctype="multipart/form-data">
				    <p>Masukan Data Karyawan / Team </p>
				    <table width="616" border="0">
                      <tr>
                        ...
                        <td width="445"><label>
                          <table width="452" border="0">
                            <tr>
                              <td width="188"><input name="nama" type="text" class="form-control" id="Judul"/></td>
                              <td></td>
                      ...
                      <tr>
                        ...
                        <td><label>
                          <table width="449" border="0">
                            <tr>
                              <td width="190"><input name="posisi" type="text" class="form-control" id="Jenis"/></td>
                             <td></td>
                      ...
                      <tr>
                        <td>Facebook</td>
                        <td>:</td>
                        <td><input name="facebook" type="text" class="form-control" id="facebook" placeholder="Masukan Alamat Facebook jika Punya"/></td>
                      </tr>
					  <tr>
                        <td>Linked in </td>
                        <td>:</td>
                        <td><input name="Linked" type="text" class="form-control" id="Linked" placeholder="Masukan Alamat Linked In jika Punya"/></td>
                      </tr>

<tr>
                        <td>Twitter</td>
                        <td>:</td>
                        <td><input name="twiter" type="text" class="form-control" id="twiter" placeholder="Masukan Alamat Twitter jika Punya"/></td>
                      </tr>
						<tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
