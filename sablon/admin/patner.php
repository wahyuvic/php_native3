...
?>
        ...
        <div id="page-wrapper">
		 ...
		 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">Damar Apparel - Patner (Kerjasama / Bisnis) </h1>
                    </div>
              </div>
                <!-- /. ROW  -->
			  <div class="row">
			    ...
			    <p> <a href="form_patner.php" class="btn btn-danger"><i class="fa fa-link"></i>Data Baru </a>
			     <?php 
            ...
            ?>
			      ...
			      <div id="dataTables-example_wrapper">
                    <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="147">Alamat URL </th>
                                                <th width="124">Gambar</th>
										...
										$query_patner  ="SELECT * FROM  kerjasama order by id_kerjasama ASC  LIMIT $offset, $dataPerPage ";
										$result_patner = mysqli_query($conn,$query_patner);
										while ($hasil_lopping = mysqli_fetch_array($result_patner)) {
										?>
                                            <tr>
                                                <td><?php echo"$hasil_lopping[0]";?></td>
                                                <td><?php echo"$hasil_lopping[1]";?></td>
                                                <td><?php echo"$hasil_lopping[2]";?></td>
                                                <td><img src="../img/logos/<?php echo"$hasil_lopping[3]";?>" width="123" height="66"/></td>
                                                <td><a href="edit_patner.php?id=<?php echo"$hasil_lopping[0]";?>" class="btn btn-danger"><i class="fa fa-edit">Edit </i></a>-<a href="olahdata/patner.php?id=<?php echo"$hasil_lopping[0]";?>&Olahdata=delete" class="btn btn-danger"><i class="fa fa-pencil">Hapus</i></a></td>
                                            </tr>
                                        <?php
										}
										?>
								    ...
								    <?php
echo "</table>";
$query   = "SELECT COUNT(*) AS jumData FROM kerjasama";
